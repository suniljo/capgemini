...
public class RandomDataLoader {
    ...
    public void loadSentencesIntoVectorStore() {
        List<String> sentences = List.of(
                ...
                "Latest version of Java is JDK 25",
                "Java is simple, powerful and robust language",
                "Java is multithread and got built-in exception handling",
                "Java is a high level language",
                "Study Java and assure Visa to USA"
        );
