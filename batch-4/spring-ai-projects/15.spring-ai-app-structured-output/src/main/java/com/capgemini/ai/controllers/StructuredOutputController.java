...
import com.capgemini.ai.model.CountryCities;
...
public class StructuredOutputController {
    ...
    @GetMapping("/chat")
    public ResponseEntity<String> chatHandler(@RequestParam("message") String message) {
        String countryCities = chatClient.prompt()
                								.user(message)
                								.call()
                								.content();
